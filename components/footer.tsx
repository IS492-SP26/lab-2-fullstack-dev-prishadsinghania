    ...
    <footer className="border-t border-border py-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6">
        ...
        <div className="font-mono text-xs text-muted-foreground">
          ...
          {" $ echo "}
          <span className="text-primary">{"\"Built with curiosity & code\""}</span>
        </div>
        ...
        <div className="flex items-center gap-5">
          {[
            ...
            <a
              ...
              aria-label={s.label}
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-border text-muted-foreground transition-all hover:border-primary hover:text-primary hover:shadow-sm hover:shadow-primary/10"
            >
        ...
        <p className="text-center font-mono text-xs text-muted-foreground/60">
          {"/* Prisha Singhania 2025 | All rights reserved */"}
        </p>
      </div>
    </footer>
  )
